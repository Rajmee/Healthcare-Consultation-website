                  ...
                  <div class="col-md-4">
                     ...
                     <div class="panel">
                        <div class="panel-heading">
                           <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle collapsed" href="#faq1" aria-expanded="false"><i class="ti-info-alt" aria-hidden="true"></i>How can we support customer?</a></h4>
                        </div>
                     ...
                     <div class="panel">
                        <div class="panel-heading">
                           <h4 class="panel-title"><a data-parent="#accordion" data-toggle="collapse" class="panel-toggle" href="#faq2" aria-expanded="true"><i class="ti-info-alt" aria-hidden="true"></i>Why customer get touch with us?</a></h4>
                        </div>
                  ...
                  <div class="row text-img-block text-xs-left">
                     <div class="container">
                        ...
                        <div class="col-xs-12 col-sm-6 left-text">
                           ...
                           <p>Now you can make medicine happen pretty much wherever you are thanks to the free easy-to-use Medicine Delivery &amp; Consulation App.</p>
            ...
            <div class="container">
               ...
               <div class="row top-footer">
                  <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                     <a href="#"> <img src="images/doc-logo.png" alt="Footer logo"> </a> <span>Order Delivery &amp; Consult </span>
                  </div>
                  ...
                  <div class="col-xs-12 col-sm-2 pages color-gray">
                     ...
                     <ul>
                        ...
                        <li><a href="registration.php">Customer Sign Up</a> </li>
                        <li><a href="#">Pricing</a> </li>
                        <li><a href="#">Make order</a> </li>
                        <li><a href="dishes.php">Add to cart</a> </li>
                     </ul>
                  </div>
                  <div class="col-xs-12 col-sm-3 popular-locations color-gray">
                     ...
                     <ul>
                        ...
                        <li><a href="#">Old Dhaka</a> </li>
                        <li><a href="#">Shonir Akhra</a> </li>
                        <li><a href="#">Khilgaon</a> </li>
                        <li><a href="#">Basabo</a> </li>
                        <li><a href="#">Dhanmondi</a> </li>
                        <li><a href="#">Shahabag</a> </li>
                        <li><a href="#">Midford</a> </li>
                        <li><a href="#">Mugda</a> </li>
                     </ul>
                  </div>
               </div>
               <!-- top footer ends -->
