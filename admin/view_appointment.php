                  ...
                  <table id="myTable" class="table table-bordered table-striped">
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td>
                          <center>
                            <a href="javascript:void(0);" onClick="popUpWindow('appointment_update.php?form_id=<?php echo htmlentities($rows['id']); ?>');" title="Update order">
                      ...
                      <tr>
                        ...
                        <td>
                          <center>
                            <a href="javascript:void(0);" onClick="popUpWindow('userprofileappointment.php?newform_id=<?php echo htmlentities($rows['id']); ?>');" title="Update order">
                      ...
                      <tr>
                        ...
                        <td>
                          <center>$<?php echo $rows['fee']; ?></center>
                        </td>
