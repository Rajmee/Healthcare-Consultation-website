                  ...
                  <div class="row">
                    ...
                    <table>
                      ...
                      <tbody>
                        ...
                        $query_res = mysqli_query($db, "select * from appointment_list where patient_id='" . $_SESSION['user_id'] . "'");
                        ...
                        ?>
                            <tr>
                              <td data-column="Item"> <?php echo $row['doc_name']; ?></td>

                              <td data-column="price">$<?php echo $row['fee']; ?></td>
                              ...
                              <td data-column="Action"> <a href="delete_appointment.php?appointment_del=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure you want to cancel your appointment?');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a>
                                <a href="javascript:void(0);" onclick="popUpWindow('prescription_data.php?newform_id=<?php echo htmlentities($row['id']); ?>');" class="btn btn-success btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-hospital-o" style="font-size:16px"></i></a>
                              </td>
